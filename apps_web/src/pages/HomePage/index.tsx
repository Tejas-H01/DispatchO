...
const HomePage: FunctionComponent = () => {
  return (
    <SpaceBetween size='l'>
      <Header variant='h1'>Route Optimization Sample</Header>
      <Container header={<Header variant='h2'>Scenario</Header>}>
        <Box variant='p'>Optimize order dispatching and delivery route for medical supplies</Box>
        <Box padding={{ left: 'm' }}>
          <ul>
      ...
      <Container header={<Header variant='h2'>Business considerations</Header>}>
        <Box padding={{ left: 'm' }}>
          <ul>
