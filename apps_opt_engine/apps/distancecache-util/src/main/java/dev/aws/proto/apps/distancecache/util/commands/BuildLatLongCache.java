...
public class BuildLatLongCache implements Callable<Integer> {
    ...
    private final String buildDateTime = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"));
    private final String s3OutputFilenamePrefix = "cache/";

    @CommandLine.Option(names = {"-os3", "--outputS3"}, description = "The default S3 output key")
