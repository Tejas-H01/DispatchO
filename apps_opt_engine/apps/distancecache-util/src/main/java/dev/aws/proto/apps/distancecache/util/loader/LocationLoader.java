...
public class LocationLoader {
    ...
    public static List<ILocation> loadLocationsFromJsonFile(File locationsFile) throws IOException {
        ...
        return loadedPoints.stream().map(c -> (ILocation) new ILocation() {
            @Override
            public String id() {
                return null;
            }
    ...
    public static List<ILocation> loadLocationsFromCsvFile(File locationsFile) throws IOException {
        ...
        try (CSVReader reader = new CSVReaderBuilder(
            ...
            return r.stream().map(x -> {
                ...
                return (ILocation) new ILocation() {
                    @Override
                    public String id() {
                        return x[0];
                    }
    ...
    public static List<ILocation> loadLocationsFromDdb(List<Map<String, String>> ls) {
